...
export type TabType = 'home' | 'query' | 'table' | 'database' | 'dashboard' | 'model' | 'saved-queries' | 'settings' | 'dashboards' | 'brain' | 'admin' | 'pipelines' | 'models' | 'telemetry'
...
export interface SingletonTab extends TabBase {
  type: 'saved-queries' | 'settings' | 'dashboards' | 'brain' | 'admin' | 'pipelines' | 'models' | 'telemetry'
}
